...
function AllSlides() {
  ...
  return (
    <div className="bg-black print:bg-white">
      {slides.map((slide) => (
        <div
          key={slide.id}
...
function SlideViewer() {
  ...
  const handleDownloadPDF = (e: React.MouseEvent) => {
    e.stopPropagation();
    window.open(`${base}/allslides?print=true`, "_blank");
  };
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="pdf-download-btn absolute top-4 right-4 flex items-center gap-2 bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white text-sm font-medium px-4 py-2 rounded-lg border border-white/20 transition-all hover:border-white/40 z-50"
